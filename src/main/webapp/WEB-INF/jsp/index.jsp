...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <span class="logo navbar-logo f-l mr-10 hidden-xs" ><a href="/sys/gotoIndex" class="logo navbar-logo f-l mr-10 hidden-xs">鲜花进销存管理系统</a></span>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<p class="f-20 text-success">欢迎使用鲜花进销存管理系统</p>
